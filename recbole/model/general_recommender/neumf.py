...
class NeuMF(GeneralRecommender):
    ...
    def predict(self, interaction):
        ...
        # print(torch.cat((mf_output, mlp_output), -1))
        # print(self.predict_layer(torch.cat((mf_output, mlp_output), -1)))
        # print(output)
        # print(self.sigmoid(self.predict_layer(torch.cat((mf_output, mlp_output), -1))/5))
        # breakpoint()
