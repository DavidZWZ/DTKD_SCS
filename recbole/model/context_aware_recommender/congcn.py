...
class ConGCN(ContextRecommender):
    r"""ConGCN is a GCN-based Context-aware recommender model.
    ...
    def __init__(self, config, dataset):
        super(ConGCN, self).__init__(config, dataset)

        # for gneraldataloader load dataset info
